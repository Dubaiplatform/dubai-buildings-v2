...
export default function FloatingButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-2 items-end bg-black/50 p-2 rounded-full">
      {/* WhatsApp */}
      <a
        href="https://wa.me/971581514623"
        target="_blank"
    ...
    "
      ...
      <a
        ...
        aria-label="Call Dubai Buildings"
      ...
      <button
        ...
        className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-14 md:h-14 bg-[#F59E0B] rounded-full shadow-lg hover:scale-110 transition-transform"
      >
        <svg fill="white" viewBox="0 0 24 24" className="w-6 h-6">
