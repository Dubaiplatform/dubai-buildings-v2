  ...
  return (
    ...
    "
      ...
      <button
        ...
        className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-14 md:h-14 bg-black/70 rounded-full shadow-lg hover:scale-110 transition-transform"
      >
        <svg fill="white" viewBox="0 0 24 24" className="w-6 h-6">
